...
When I was at college, I saw the [Free Software movement](https://www.gnu.org/philosophy/free-sw.en.html) [0] as the only possible way to ethically produce software. I helped to organize two FliSol in my city. I use to help any person that needed help migrating to a Free Software. Everything because I believed in the words of the prophet. I believed software was information and you should never hide information. Imagine, discovering the vaccine for Corona virus and keeping it hidden? No, that sounded horrible.
