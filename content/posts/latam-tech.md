...
In general, the type of work is different in the two hemispheres. In the rich north is easier to find jobs where you have to create new frameworks, languages or entire platforms, while in the poor south we use tools to serve the needs of other business (from both hemispheres). Technology in the north is seeing as an investment in itself, while the south sees it as a needed cost to accomplish something else.

Salaries are also very different and that contributes to the number of engineers leaving the country. [Glassdoor ](https://www.glassdoor.com.br/Sal%C3%A1rios/engenheiro-de-software-s%C3%AAnior-sal%C3%A1rio-SRCH_KO0,29.htm) says the average salary for a senior software engineer in Brazil is around 1628 euros per month, [pay scale](https://www.payscale.com/research/BR/Job=Software_Engineer/Salary) on other hand says 14 thousand euros per year across all seniorities. According to [Glassdoor](https://www.glassdoor.ie/Salaries/dublin-software-engineer-salary-SRCH_IL.0,6_IM1052_KO7,24.htm?countryRedirect=true) the average in Dublin is 52,635 euros.  It’s not without a reason that Amazon/AWS promotes regularly hiring events in South America where they hire everybody that “raises the bar”.

But this does not mean we are not creating amazing tech in LATAM. We have several great examples like the Lua and Elixir languages and fklearn from NuBank. We also have big companies like MercadoLibre, Rappi, NuBank, Buscapé  and others. For a while, libre software was even government policy. One great example is Lula, the ex-President of Brazil. He visited the Fórum Internacional Software Livre where he spoke to all the libre software importance. 

We also have very good universities like Pontifical Catholic University of Chile (UC), Universidade Estadual de Campinas, Universidade de São Paulo, and others. Those universities are responsible for great tech advancements, such as [ginga](http://www.ginga.org.br/en) or Lua. 

What we meanly miss is better salaries for the workers and R&D investments. R&D is a big issue, especially if we remove public funding. More than half of the investments are made by the public sector in Brazil, while in countries like USA the private sector is responsible for more than 60% ([according to the Brazilian Senate in 2012](https://www.senado.gov.br/noticias/Jornal/emdiscussao/inovacao/ciencia-tecnologia-e-inovacao-no-brasil/investimento-em-pesquisa-e-desenvolvimento-no-brasil-e-em-outros-paises-o-setor-privado.aspx)). [There are a couple of examples where R&D is done by universities in association with the private sector](https://www.unicamp.br/unicamp/index.php/ju/noticias/2019/03/12/centro-de-inovacao-da-unicamp-quer-ampliar-parcerias-com-farmaceuticas]), but not in the same size as the USA, for example.

Regarding innovation, according to the [Global Innovation Index - 2019](https://www.globalinnovationindex.org/gii-2019-report), Mexico is in 56 position, Uruguay, 62, and Brazil 66 (Brazil was in 64 position in 2018, and 61 in 2013). If you are curious you can check the [in-depth report](https://www.globalinnovationindex.org/analysis-economy) about the Brazilian economy. It’s pretty scary that we are in the 47 position for “Knowledge creation”, but  86 for ”Knowledge impact”.
...
I kept working there (I moved jobs for 6 months to try the startup life and I spend two months without working to be able to do the Master degree classes, but I later came back to the same company), and when I left Brazil I was making around 5000 BRL or 800 EUR. The signing bonus to work for AWS was bigger than my annual salary.
...
Or, my two cents about those issues:

We need to be able to support more people in the public universities, not only by increasing the number of students but by given all those who need scholarships. We cannot expect people to innovate if they have to work 40 hours a week to barely pay for food. Those students could work in their university labs researching solutions for their own communities.

Big corporations in Brazil need to invest in local R&D, addressing local problems. We cannot be a country where corporations sell their foreigner product and send the profit away or a place where most tech work is manual work (e.g.  mechanical turk, small customisation of business logic for local markets). Those same companies are trying to automate those jobs as we speak, if we depend on it to eat, we are going to starve.

[Software bought with public money should be open sourced](https://publiccode.eu/openletter/). We want the power to modify and inspect software that we depend on. This is a security measure and a social one.

We need a more just social-economic system, where workers are not paid low salaries so the corporations can increase their profit. We need workers council to make decisions about how the work is going to be done, where the money is going to be invested and what is acceptable clients (e.g. no tech for ICE, USA military or latifundios!). LATAM has the resources (people and financial) to lead social changes through technology. We just need to stop feeding the vultures.